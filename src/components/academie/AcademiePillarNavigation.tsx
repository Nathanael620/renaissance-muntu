...
/**
 * Section « Explorer les autres piliers » — version Académie.
 * La carte « Académie Muntu » est signalée comme page active afin de rappeler
 * que l'on demeure dans le même institut.
 */
...
export default function AcademiePillarNavigation() {
    ...
    >
      <div className="mx-auto max-w-[1440px]">
        ...
        <div className={cn("grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-5", visible && "animate-fade-in")}>
          {pillars.map((pillar) => {
            const isActive = pillar.slug === "academie-muntu";
